...
import com.encee.MTA.admin.dao.customer.CustomerDAO;
import com.encee.MTA.admin.domain.customer.CustomerDomain;
import com.encee.MTA.admin.mapper.customer.CustomerMapper;
...
public class CustomerServiceImpl implements CustomerService {
	...
	public Response addCustomer(CustomerModel customerModel) throws Exception {
		...
		try {
			...
			customerDomain.setPassword(CommonUtils.encriptString(customerModel.getPassword()));
