package com.encee.MTA.admin.dao.bank;
...
public class BankDAOImpl implements BankDAO {
	...
	public BankDomain getBank(long id) throws Exception {
		try {
			String hql="From BankDomain where id=?1 and status=true";
	...
	public List<BankDomain> getBanks() throws Exception {
		try {
			String hql="From BankDomain where status=true";
